...
output "terraform_ci_user_name" {
  description = "The user's name"
  value       = "${aws_iam_user.terraform_ci.name}"
}

output "terraform_ci_user_unique_id" {
